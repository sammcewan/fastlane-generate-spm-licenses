        ...
        begin
          ...
          licenses = checkout_folders
            ...
            if excluded.include?(name)
              UI.message("Skipping license for #{name}")
              nil
            elsif File.exist?(raw_license)
            ...
            UI.message("Found license for #{license.name}")
      ...
      def self.available_options
        ...
        [
          ...
          FastlaneCore::ConfigItem.new(key: :exclude,
                                       env_name: "FL_LICENSES_EXCLUDE",
                                       description: "Exclude an array or package names",
                                       is_string: false,
                                       default_value: false),
